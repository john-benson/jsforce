...
Client.prototype._prompt = function(options, callback) {
  ...
  pw.addEventListener("loadstart", function(event) {
  ...
  var pid = setInterval(function() {
    try {
      if (handleCallbackResponse() || !pw || pw.closed) {
        clearInterval(pid);
...
Client.prototype._removeTokens = function() {
  ...
  localStorage.removeItem(this._prefix + '_refresh_token', params.refresh_token);
};
